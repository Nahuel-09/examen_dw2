...
if (!defined('NAME_TABLE')) define("NAME_TABLE","recintos"); // Nombre de la tabla
...
if (!defined('DB_NAME')) define("DB_NAME", "recintos_db"); // Nombre de la base de datos
// Informacion de los directorios
if (!defined('SAVE_IMG')) define("SAVE_IMG", __DIR__ . "/../../" . "images/"); // La carpeta en donde quiero guardar mis imagenes
if (!defined('SAVE_JSON')) define("SAVE_JSON", __DIR__ . "/../../" . "API/"); // La carpeta en donde quiero guardar mis imagenes
?>